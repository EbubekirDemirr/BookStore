    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAndAuthors", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAndCategories", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAndPublishers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookAndPublishers_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookAndPublishers_Publishers_PublisherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookAndCategories_BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookAndPublishers_BookId",
                table: "BookAndPublishers",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookAndPublishers_PublisherId",
                table: "BookAndPublishers",
                column: "PublisherId");
